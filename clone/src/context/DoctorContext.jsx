...
// ✅ قيمة افتراضية تمنع undefined errors
...
export function DoctorsProvider({ children }) {
  ...
  return (
    <DoctorsContext.Provider
      value={{ doctors, setDoctors, addDoctor, deleteDoctor }}
    >
      {children}
    </DoctorsContext.Provider>
  );
